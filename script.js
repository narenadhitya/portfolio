...
const TECH = [
  ...
  {name:'TensorFlow',color:'#FF6F00'},{name:'FastAPI',color:'#009688'},
  {name:'React',color:'#61DAFB'},{name:'LangChain',color:'#3C8C63'},
  {name:'Scikit-learn',color:'#F7931E'},{name:'OpenCV',color:'#5C3EE8'},
  {name:'PostgreSQL',color:'#4169E1'},{name:'pgvector',color:'#6A5ACD'},
  {name:'Ollama',color:'#E0E0E0'},{name:'Git',color:'#F05032'},
  {name:'Linux',color:'#FCC624'},{name:'JavaScript',color:'#F7DF1E'},
